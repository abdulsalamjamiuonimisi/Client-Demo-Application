...
@Component({
  selector: 'app-sub-kpi-test',
  templateUrl: './sub-kpi-test.component.html',
  styleUrls: ['./sub-kpi-test.component.scss']
})
export class SubKpiTestComponent implements OnInit {
